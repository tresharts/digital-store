    ...
    return (
        <>
          <div className='grid grid-cols-1 md:grid-cols-2 px-16 bg-light-gray    '>
            <div className=' flex flex-col justify-center md:items-start mt-10 md:mt-0 md:px-20 order-2 md:order-1  '>
                <div className='text-primary-dark md:text-yellow-500 font-bold text-center text-sm md:text-lg mb-2 md:mb-4'>
                ...
                <div className='w-full mb-6 md:mb-0'>
                    <button className=' bg-primary hover:bg-primary-dark p-2 w-full md:w-1/2 rounded text-white'>Ver Ofertas</button>
                </div>
            </div>
